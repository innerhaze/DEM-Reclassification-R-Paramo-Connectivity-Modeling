...
We will now iterate over each elevation range to reclassify the DEM into cost rasters. These rasters will assign resistance values based on elevation, simulating different terrain conditions.
...
Finally, we save all the reclassified rasters to a specified folder. The files are saved in GeoTIFF format, which is commonly used for geospatial data.
